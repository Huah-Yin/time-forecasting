...
XGBoost params: {'colsample_bytree': 0.8, 'learning_rate': 0.01, 'max_depth': 5, 'n_estimators': 50, 'subsample': 1.0}
...
XGBoost参数: {'colsample_bytree': 0.8, 'learning_rate': 0.01, 'max_depth': 5, 'n_estimators': 50, 'subsample': 1.0}
...
图表已保存为: plots\differenced_COD_for_acf_pacf.png
图表已保存为: svg\differenced_COD_for_acf_pacf.svg
